...
module.exports = {
    SESSION_ID: process.env.SESSION_ID === undefined ? 'PINKVENOM-MD;vddDFBKD#CcVJbIyvhSI1Wuo5iReo9J9jsCReEMNlurbOjM0bhFs' : process.env.SESSION_ID, //ADD YOUR SESSION ID
    GITHUB_USER_NAME: process.env.GITHUB_USER_NAME === undefined ? 'xchamo58' : process.env.GITHUB_USER_NAME, //ADD YOUR GITHUB USERNAME
    GITHUB_AUTH_TOKEN: process.env.GITHUB_AUTH_TOKEN === undefined ? 'b3tMx9y5laH2zV9levAvymhLMZJ7OE33MPtF' : process.env.GITHUB_AUTH_TOKEN, //ADD YOUR GITHUB AUTH TOKEN WITHOUT gph_ ,  example - G5OxxdvEbiBPWxm4A0xypQGlyCr4FS267ifz
    ...
    OWNER: process.env.OWNER === undefined ? `94743430452` : process.env.OWNER, //BOTS OWNER NUMBER
